...
namespace WebStore.Components
{
    public class SectionsViewComponent : ViewComponent
    {
        ...
        private IEnumerable<SectionViewModel> GetSections()
        {
            ...
            var parent_scetions_views = parent_sections
            ...
            foreach (var parent_section in parent_scetions_views)
            {
            ...
            parent_scetions_views.Sort((a, b) => Comparer<int>.Default.Compare(a.Order, b.Order));
            return parent_scetions_views;
        }
    }
}
